...
def _replay_strike_on_real(
    ...
    strike_direction = np.array(strike_direction, dtype=float)
    strike_direction /= np.linalg.norm(strike_direction)

    # 현재 TCP 자세 유지
    p_now = indy.get_control_state()['p']
    rx, ry, rz = p_now[3], p_now[4], p_now[5]

    # ==========================
    # HOME -> WP1
    # ==========================
    wp1 = np.array(ball_pos) - strike_direction * approach_dist
    ...
    print("\n==========================")
    print("Waypoint 1")
    print("ball_pos - strike_dir * approach_dist")
    print("ENTER -> MoveL")
    print("==========================")
    input()
    ...
    # WP1 -> WP2
    # ==========================
    wp2 = np.array(ball_pos) + strike_direction * follow_dist
    ...
    print("\n==========================")
    print("Waypoint 2")
    print("ball_pos + strike_dir * follow_dist")
    print("ENTER -> Strike")
    print("==========================")
    input()
